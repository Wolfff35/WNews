...
/**
 * Created by wolff on 21.07.2017.
 */

public class __VerticalViewPager extends ViewGroup {
     ...
     */
    public __VerticalViewPager(Context context, AttributeSet attrs) {
     ...
     */
    public __VerticalViewPager(Context context, AttributeSet attrs, int defStyle) {
